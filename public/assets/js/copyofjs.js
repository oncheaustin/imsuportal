    ...
    jQuery("#formID").validationEngine('attach', {
        onValidationComplete: function (form, status) {
            ...
            if (status == true) {
                ...
                dp1 = $("select[name=department1]").attr('id');
                dp2 = $("select[name=department2]").attr('id');
                cs1 = $("select[name=course1]").attr('id');
                if ($("#crs option:selected").val()=="ND") {
                    var prog = '<span style="margin-right: 40px;" ><b>Jamb Regno: </b> ' + $("#jambregno").val() + ' </span>  <span style="margin-right: 40px;"><b>Jamb Score: </b> ' + $("#jambscore").val() + ' </span>   <spanstyle="margin-right: 40px;" ><b>Pre-ND Regno: </b> ' + $("#prend").val() + ' </span> '
                } else if ($("#center option:selected").val() == "") {
                         } else {
                    var prog = ""
                }
           
                if ($("#examtype2").find("option:selected").val() != "") {
                    sitting2 = ''
                } else {
                    sitting2 = ""
                }
                ...
                cs2 = $("select[name=course2]").attr('id');
                var dat = $(":text[name='dp1']").attr('id');
                $.colorbox({
                    html: ' <div style=" text-transform:capitalize; overflow-y:auto; overflow-x:hidden; padding-right:12px;   line-height:24px; letter-spacing: 1.5px;   font-size:17px;  max-height:513px; margin-left:10px"> <fieldset > <legend><strong>Personal Information</strong> </legend> </fieldset> <center><img id="image"  src="" style="height: 150px; min-width:145px ;" /></center> <br> <center><div    >   <span style="padding-left:10px"><strong>Name:</strong> </span> ' + $("#lastname").val() + " " + $("#firstname").val() + " " + $("#other").val() + '<br>   <span ><b>Date Of Birth: </b> ' + $("#" + dat).val() + ' </span><br> <span ><b>Sex: </b> ' + $("#sex").val() + ' </span> <br><span ><b>Marital Status: </b> ' + $("#status").val() + ' </span><br><span ><b>Disability: </b> ' + $("#disability").val() + ' </span><br><span > <b>Address: </b> ' + $("#address").val() + ' </span>  <br><span ><b>Phone: </b> ' + $("#phone").val() + ' </span>   <br><span ><b>Nationality: </b>  ' + $("#nationality").val() + '  </span>     <br><span ><b>State Of Origin: </b>  ' + $("#state").val() + ' </span>      <br><span ><b>L.G.E.A.: </b> ' + $("#lga").val() + ' </span>   </div></center><br>     <fieldset > <legend><strong>Program Of Study </strong></legend> </fieldset> <span > <b>Program </b> ' +$("#crs option:selected").val() + ' </span> <br>'+ prog + ' <br> <br><table class="table table-bordered"   ><tr><td width="5%">Choice </td> <td width="25%">School</td> <td width="26%"> Department</td><td width="26%" >Course</td> </tr><tr><td>1st</td><td>' + $("#school11").find("option:selected").text() + '</td><td> ' + $("#" + dp1).find("option:selected").text() + ' </td><td>'+ $("#crs option:selected").text() +'</td></tr></table>   <fieldset > <legend><strong>Academic History</strong> </legend> </fieldset>   <table  class="table table-bordered"  ><thead><tr><th>S/N</th><th>Institutions/Schools Attended</th><th>From</th> <th>To</th><th>Qualifications</th></tr></thead> <tbody><tr><td>1</td><td  > <div style=" width:247px;word-wrap: break-word;"> ' + $("#school1").val() + '  </div></td><td> ' + $("#frm0").val() + '  </td><td>' + $("#to0").val() + '  </td><td>   ' + $("#qualification1").val() + '  </td> </tr>     <tr> <td>2</td> <td> <div style=" width:247px;word-wrap: break-word;">' + $("#school2").val() + ' </div> </td>  <td> ' + $("#from2").val() + '  </td> <td>   ' + $("#to2").val() + '   </td> <td> <div style=" width:247px;word-wrap: break-word;">  ' + $("#qualification2").val() + '</div></td> </tr> <tr><td>3</td> <td><div style=" width:247px;word-wrap: break-word;">' + $("#school3").val() + '   </div>  </td> <td>  ' + $("#from3").val() + '  </td>  <td> ' + $("#to3").val() + '  </td><td> <div style=" width:247px;word-wrap: break-word;"> ' + $("#qualification3").val() + ' </div> </td></tr><tr><td>4</td><td><div style=" width:247px;word-wrap: break-word;">   ' + $("#school4").val() + ' </div></td>  <td> ' + $("#from4").val() + '   </td><td>   ' + $("#to4").val() + '  </td><td><p>' + $("#qualification4").val() + '  </p>  <input style="visibility:hidden;"  value="    ' + $("#qualification4").val() + ' " type="text"> </td></tr></tbody></table><fieldset > <legend><strong> O &acute; Level</strong> </legend> </fieldset><div class="row-fluid"> <div class="span6 "> <div class="control-group"> <label class="control-label" for="examtype1">Exam Type</label> <div class="controls">' + $("#examtype1").find("option:selected").val() + ' &nbsp;</div> </div> <div class="control-group"> <label class="control-label" >Exam Number</label> <div class="controls"> ' + $("#examnumber1").val() + '&nbsp; </div> </div> <table cellpadding="" class="table table-bordered"> <thead> <tr><th></th> <th>Subjects</th> <th>Grades</th> </tr></thead> <tbody><tr> <td>1</td> <td> ' + $("#sbj1-1").find("option:selected").val() + ' </td> <td>  ' + $("#grade1-1").find("option:selected").val() + ' </td> </tr> <tr> <td>2</td> <td>' + $("#sbj1-2").find("option:selected").val() + '</td> <td> ' + $("#grade1-2").find("option:selected").val() + ' </td> </tr> <tr> <td>3</td> <td>' + $("#sbj1-3").find("option:selected").val() + ' </td> <td>' + $("#grade1-3").find("option:selected").val() + ' </td> </tr> <tr> <td>4</td> <td>' + $("#sbj1-4").find("option:selected").val() + '  </td> <td> ' + $("#grade1-4").find("option:selected").val() + '  </td> </tr> <tr> <td>5</td> <td> ' + $("#sbj1-5").find("option:selected").val() + '  </td> <td> ' + $("#grade1-5").find("option:selected").val() + '  </td> </tr> <tr> <td>6</td> <td> ' + $("#sbj1-6").find("option:selected").val() + '</td> <td> ' + $("#grade1-6").find("option:selected").val() + ' </td> </tr> <tr> <td>7</td> <td> ' + $("#sbj1-7").find("option:selected").val() + ' </td> <td> ' + $("#grade1-7").find("option:selected").val() + ' </td> </tr> <tr> <td>8</td> <td> ' + $("#sbj1-8").find("option:selected").val() + '</td> <td> ' + $("#grade1-8").find("option:selected").val() + ' </td> </tr> <tr> <td>9</td> <td> ' + $("#sbj1-9").find("option:selected").val() + '</td> <td> ' + $("#grade1-9").find("option:selected").val() + '</td> </tr> </tbody></table> </div>      </div>  </div> <br> </div>  <div align="center"style="background:rgb(185, 196, 207); margin-left:10px; height:47px; margin-right:10px;"> <p  style="margin-left:445px;"><strong>Click On the Icon Below to Continue Or Go Back to the Form  </strong></div>  ',
                    trapFocus: true,
                    fixed: true,
                    height: "654px",
                    width: "900px",
...
$(document).ready( function() {
 ...
 $("#crs,#school11" ).on("change", function () {
 $("#loading").fadeIn(940);
if($("#crs option:selected").val()=="ND"){
 $("#jamb").fadeIn(940);
}else{
